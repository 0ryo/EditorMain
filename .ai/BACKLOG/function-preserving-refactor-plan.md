...
| 3. 3D editing | Selection passed; awaiting outliner verification | `refactor: separate placed object selection processing`<br>`refactor: separate outliner data processing` | Outliner pending |
