...
| 2. Placement/catalog/import | Catalog passed; awaiting placement verification | `refactor: separate catalog card state and filtering`<br>`refactor: separate placement prefab and object creation` | Catalog passed; placement pending |
